...
6110 GET# 2,Y$: POKE 53281,ASC(Y$+Z$): REM SET BACKGROUND COLOR
6120 CLOSE 2
6130 FOR X=1612 TO 1621: POKE X,3: NEXT X: REM HIDE GAME OVER MESSAGE
6140 POKE 53265,PEEK(53265) OR 16: REM SET SCREEN VISIBLE
6150 FOR X=0 TO 9: FOR Y=O TO 7: READ Z: N(X,Y)=Z: NEXT Y: NEXT X
6160 RETURN
